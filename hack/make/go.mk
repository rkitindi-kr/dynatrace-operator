...
go/integration_test:
	go test -ldflags="-X 'github.com/rkitindi-kr/dynatrace-operator/pkg/version.Commit=$(shell git rev-parse HEAD)' -X 'github.com/rkitindi-kr/dynatrace-operator/pkg/version.Version=$(shell git branch --show-current)'" ./test/integration/*
